...
trait REST_Controller
{
    ...
    protected $http_status_codes = [
        REST::HTTP_OK => 'OK',
        REST::HTTP_CREATED => 'CREATED',
        REST::HTTP_NO_CONTENT => 'NO CONTENT',
        REST::HTTP_NOT_MODIFIED => 'NOT MODIFIED',
        REST::HTTP_BAD_REQUEST => 'BAD REQUEST',
        REST::HTTP_UNAUTHORIZED => 'UNAUTHORIZED',
        REST::HTTP_FORBIDDEN => 'FORBIDDEN',
        REST::HTTP_NOT_FOUND => 'NOT FOUND',
        REST::HTTP_METHOD_NOT_ALLOWED => 'METHOD NOT ALLOWED',
        REST::HTTP_NOT_ACCEPTABLE => 'NOT ACCEPTABLE',
        REST::HTTP_CONFLICT => 'CONFLICT',
        REST::HTTP_INTERNAL_SERVER_ERROR => 'INTERNAL SERVER ERROR',
        REST::HTTP_NOT_IMPLEMENTED => 'NOT IMPLEMENTED'
    ];
    ...
    public function _remap($object_called, $arguments = [])
    {
        ...
        if ($this->config->item('rest_enable_keys') && empty($this->rest->key) === false) {
            ...
            if ($this->config->item('rest_enable_limits') && $this->_check_limit($controller_method) === false) {
                ...
                $this->response($response, REST::HTTP_UNAUTHORIZED);
            }
    ...
    public function response($data = null, $http_code = null, $continue = false)
    {
        ...
        // $token = $this->validate_token->generateToken(mt_rand());
        // $this->output->set_header("Authorization: '$token'");
        // $this->output->append_output($token);
        ...
        if (!$isProfilingEnabled) {
            ...
            $http_code > 0 || $http_code = REST::HTTP_OK;
